        ...
        <Carousel className="px-12">
          <CarouselContent className="gap-8">
            {testimonials.map((t, idx) => (
              <CarouselItem key={idx} className="min-h-[344px] group flex flex-col justify-between basis-full sm:basis-full md:basis-1/2 xl:basis-1/3 flex-shrink-0 max-w-full xl:max-w-[540px] p-0">
                <div className="relative flex flex-col justify-between h-full w-full bg-[#7C7C7C]/5 border border-[#FFFFFF]/20 rounded-3xl px-8 py-10 shadow-[0_18px_44px_0_rgba(0,0,0,0.2)] transition-all duration-300 ease-in-out overflow-hidden hover:shadow-[0_0_24px_0_#E375E9,0_18px_44px_0_rgba(253,117,233,0.2)]">
          ...
          <CarouselPrevious className="hidden md:flex w-12 h-12 left-0" />
          <CarouselNext className="hidden md:flex w-12 h-12 right-0" />
        </Carousel>
      </div>
    </section>
  );
